  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-12 px-2 mt-8 gap-4 lg:gap-8">
          <div className="border col-span-12 md:col-span-6 lg:col-span-4 rounded-sm p-6">
          ...
          <div className="border rounded-sm col-span-12 md:col-span-6 lg:col-span-4  p-4">
        ...
        <div className=" py-5 px-4 my-14">
          <div className="text-center pt-10">
            <h1
              className="text-3xl font-bold text-[#130A5C]"
              id="#How it works"
            >
              How It Works{" "}
            </h1>
