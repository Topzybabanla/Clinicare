//classes are templates for creating javascript objects.they can inherit the exiting protypes of objects. They usually get initialize with a constructor.
...
class AppError extends Error {
  constructor(message, statusCode = 500) {
    ...
    this.success = false; //we default to false in this case cause we are handling errors
...
class ApiResponse {
  constructor(statusCode, data, message = "Success") {
    ...
    this.data = data; //api data to be sent to client
